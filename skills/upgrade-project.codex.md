...
allowed-tools: Read, Write, Edit, Bash(mkdir:*), Bash(cp:*), Bash(ls:*), Bash(find:*), Bash(cat:*), Bash(test:*), Bash(diff:*), Bash(cmp:*), Bash(date:*), Bash(env:*), Bash(${CODEX_HOME:-$HOME/.codex}/agent-setup/bin/render-templates.sh:*)
---
